...
import ExperienceCardForAccordion from '../ExperienceCardForAccordion';
...
class ExperienceAccordion extends React.Component<IProps, IState> {
            ...
            <View style={{ marginTop: Metrics.HEIGHT * 0.02 }}>
                ...
                </TouchableOpacity>
                {
                    ...
                    <View style={styles.child}>
                        <FlatList
                            data={this.props.experienceList}
                            keyExtractor={(item, index) => {
                                return index.toString();
                            }}
                            renderItem={({ item, index, separators }) => (
                                <ExperienceCardForAccordion
                                    key={index}
                                    ...
                                    onPressEdit={() => this.props.navigation.navigate("AddExperience", { selectedItemIndex: index })}
                                />
                            )}
                        />
                        <TouchableOpacity style={styles.addButton} onPress={() => this.props.navigation.navigate("AddExperience")}>
